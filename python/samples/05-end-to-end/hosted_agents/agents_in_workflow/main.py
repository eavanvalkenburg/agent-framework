...
def main():
    # Create agents
    researcher = OpenAIChatClient(backend="azure_openai", credential=DefaultAzureCredential()).as_agent(
        instructions=(
    ...
    marketer = OpenAIChatClient(backend="azure_openai", credential=DefaultAzureCredential()).as_agent(
        instructions=(
    ...
    legal = OpenAIChatClient(backend="azure_openai", credential=DefaultAzureCredential()).as_agent(
        instructions=(
