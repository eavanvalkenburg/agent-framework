...
from agent_framework.openai import OpenAIResponsesClient  # Thin client for Azure OpenAI chat models
...
- Working Azure OpenAI configuration for OpenAIResponsesClient, with Azure CLI login and required environment variables.
