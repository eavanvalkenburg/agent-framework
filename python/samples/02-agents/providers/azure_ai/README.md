...
Samples that execute an existing agent directly with `AzureAIClient` require the agent name and version to be provided either through `AZURE_AI_AGENT_NAME` / `AZURE_AI_AGENT_VERSION` or explicitly in code.
...
2. Edit the `.env` file and add your values:
   ...
   AZURE_AI_PROJECT_ENDPOINT="your-project-endpoint"
    ...
    AZURE_AI_AGENT_NAME="your-existing-agent-name"
    AZURE_AI_AGENT_VERSION="your-existing-agent-version"
   ```
...
export AZURE_AI_AGENT_NAME="your-existing-agent-name"
export AZURE_AI_AGENT_VERSION="your-existing-agent-version"
```
...
- `AZURE_AI_AGENT_NAME`: Required for direct `AzureAIClient` execution samples that target a pre-created agent
- `AZURE_AI_AGENT_VERSION`: Required for direct `AzureAIClient` execution samples that target a pre-created agent
