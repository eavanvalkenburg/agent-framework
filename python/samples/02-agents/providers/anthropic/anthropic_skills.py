...
async def main() -> None:
    ...
    beta_client: Any = client.anthropic_client.beta

    # List Anthropic-managed Skills
    skills = await beta_client.skills.list(source="anthropic", betas=["skills-2025-10-02"])
    ...
    if files:
        ...
        for idx, file in enumerate(files):
            file_content = await beta_client.files.download(file_id=file.file_id, betas=["files-api-2025-04-14"])
