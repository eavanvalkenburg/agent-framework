...
| Approval-time user input | New user-input request returns with assistant role and no extra model call. | `packages/core/tests/core/test_harness_tool_approval.py::test_approval_resume_returns_user_input_request_without_another_model_call` |
